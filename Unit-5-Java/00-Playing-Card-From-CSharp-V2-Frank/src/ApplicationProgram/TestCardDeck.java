 ...
 *
 * Since set is a subclass of collections class, like List, the same methods that work with List work with Set
 ************************************************************************************************/
 ...
 ************************************************************************************************/
        ...
        //   stores the entries in an unknown sequence (by hashcode)
        //      hashCode is a unique value representing the data in the object
       ...
       //Set<String> nameSet = new LinkedHashSet<>(); Store element in hashCode (unknown to you)
       //Set<String> nameSet = new LinkedHashSet<>(); Store element in sort sequence based on type
