...
namespace Day_6_Polymorphism
{
     ...
     *********************************************************************/
        ...
        //
        //  public means anyone with an object of the class can change that data
        // protected limits the ability to change data to subclasses (keeping access in the inheritance family)
        //---------------------------------------------------------------
